...
2. V3.21.4: mount persistente, sessioni/health, sync cloud, segnali posizione e readiness telefonia non sono più blocker. History Git riscritta e tutti i ref pubblicizzati sono puliti; resta la purga GitHub Support perché un vecchio commit non raggiungibile è ancora risolvibile per SHA. Due reality gate restano: modifica di un evento Google esistente **da ORA**; negazione/revoca e riattivazione posizione con meteo sul device.
