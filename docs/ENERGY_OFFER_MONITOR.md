...
In un controllo incrociato, il [catalogo XML del 26/09](https://www.ilportaleofferte.it/portaleOfferte/resources/opendata/csv/offerteML/2026_9/PO_Offerte_E_MLIBERO_20260926.xml) riporta 0,175 €/kWh per AJO FISSO 12, mentre la [pagina del venditore](https://ajoenergia.it/offerta-casa/ajo-fisso-12/) consultata lo stesso giorno mostra 0,1795 €/kWh per lo stesso codice offerta. La funzione resta in bozza finché l'accesso automatico dalla rete di esercizio, la coerenza dei prezzi col venditore e un ciclo completo su staging con bolletta fittizia non sono verificati.
