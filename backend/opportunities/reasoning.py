...
async def scan(
    ...
    *,
    ...
    instruction = (
        ...
        "For energy_offers, a named offer is an observed alternative, not proof "
        "that it is cheaper for this person. State a potential annual difference "
        "only when comparison_basis=seller_components_only and say it compares "
        "seller components, excluding tax, network charges and conditional terms. "
        "With current_terms_missing, price_not_comparable or consumption_missing, never call the "
        "offer better or state a saving. Cite the official export and the "
        "supplier offer page, with the observation and validity dates.\n\n"
