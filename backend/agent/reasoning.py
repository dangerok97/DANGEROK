...
async def decide_goal(
    ...
    *,
    ...
    instruction = (
        ...
        "judgement that raised this meant to go. `inform` and `recommend` "
        "mean a sentence was the whole point: those are usually `no_goal`, "
        "and turning one into a piece of work is how a helpful remark "
        "becomes an errand. A goal is for an outcome that takes several "
        "steps and somebody has to see through.\n\n"
        "Your choices:\n"
