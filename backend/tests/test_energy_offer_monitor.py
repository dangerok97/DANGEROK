...
async def test_mobile_homepages_and_tariff_lists_are_not_named_offers(monkeypatch):
    sources = [
        ...
        SimpleNamespace(source_id="iliad-list", url="https://www.iliad.it/trasparenza-tariffaria-mobile.html",
                        title="Trasparenza tecnica e tariffaria - Mobile | iliad",
                        snippet="Più piani", publisher="iliad.it"),
        SimpleNamespace(source_id="iliad-brochure", url="https://www.iliad.it/brochure-prezzi-mobile.html",
                        title="Brochure Prezzi - Mobile | iliad",
                        snippet="Più piani", publisher="iliad.it"),
