...
TXT_FIXTURES: dict[str, list[str]] = {
    ...
    "contratto_telefono": [
        "CONTRATTO TELEFONICO MOBILE - Documento sintetico di test",
        "Operatore: TelcoTest SpA",
        "Cliente: Mario Rossi Test",
        "Numero: 3331234567",
        "Piano tariffario: Unlimited Test",
        "Canone mensile: EUR 14,99",
        "Decorrenza: 1 luglio 2026",
        "Scadenza vincolo: 1 luglio 2028",
    ],
    "contratto_luce": [
        "CONTRATTO DI FORNITURA ENERGIA ELETTRICA - Documento sintetico di test",
        "Fornitore: EnergiaTest SpA",
        "Cliente: Mario Rossi Test",
        "Punto di fornitura: Via Roma 10, Milano",
        "Codice POD: IT001E12345678",
        "Tariffa: Monoraria Test",
        "Decorrenza: 1 maggio 2026",
    ],
    "busta_paga": [
        "BUSTA PAGA / CEDOLINO - Documento sintetico di test",
        "Datore di lavoro: Azienda Test SpA",
        "Dipendente: Mario Rossi Test",
        "Periodo: luglio 2026",
        "Retribuzione lorda: EUR 2.400,00",
        "Netto in busta: EUR 1.780,00",
        "Data pagamento: 27 luglio 2026",
    ],
    "verbale": [
        "VERBALE D'ESAME - Documento sintetico di test",
        "Universita' Test di Milano",
        "Corso di laurea: Informatica",
        "Esame: Basi di Dati",
        "Candidato: Mario Rossi Test",
        "Voto: 28/30",
        "Data esame: 12 gennaio 2027",
    ],
    "ambiguous": [
        "DOCUMENTO GENERICO - contenuto sintetico poco chiaro",
        "Riferimento interno ZX-99",
        "Nota: verificare allegati",
    ],
    "incomplete": [
        "FATTURA",
        "Importo: ",
    ...
    "updated_bolletta": [
        "BOLLETTA ENERGIA ELETTRICA - Documento sintetico di test (AGGIORNATA)",
        "Fornitore: EnergiaTest SpA",
        "Cliente: Mario Rossi Test",
        "Fornitura per l'indirizzo: Via Roma 10, Milano",
        "Periodo di riferimento: 01/08/2026 - 30/09/2026",
        "Codice contratto: ET-998877",
        "Importo totale da pagare: EUR 92,10",
        "Scadenza pagamento: 15 novembre 2026",
        "Consumo: 230 kWh",
    ],
    "polizza_casa": [
        "POLIZZA ASSICURATIVA CASA - Documento sintetico di test",
        "Compagnia: Assicurazioni Test SpA",
        "Numero polizza: POL-CASA-778899",
        "Immobile assicurato: Via Roma 10, Milano",
        "Contraente: Mario Rossi Test",
        "Decorrenza: 1 gennaio 2026",
        "Scadenza: 31 dicembre 2026",
        "Premio annuo: EUR 220,00",
    ],
}
